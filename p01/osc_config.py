...
class Parameters:
    ...
    def popCluster(self):
        self.numOfCores = self.config.getint("cluster", "numOfCores")
        self.numOfNodes = self.config.getint("cluster", "numOfNodes")
        self.wallTime = self.config.getint("cluster", "wallTime")
